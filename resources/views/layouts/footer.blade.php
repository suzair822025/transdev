...
<footer class="bg-gray overflow-hidden">
    ...
    <div class="col-lg-4 col-md-6 footer-item pr-30 pr-md-15 pr-xs-15">
        <div class="f-item address">
            <img src="{{ asset ('/assets/img/logo.png') }}" alt="Image Not Found">
            <span style="display: block; margin-top:-2rem; font-size:0.9rem">A product of Transinformatic LLC</span>
            <p>
...
<a href="https://wa.me/18328375503" class="whatsapp-float" target="_blank" rel="noopener">
...
<!--========== END FOOTER ==========-->
    ...
    <script defer src="{{ asset ('assets/js/isotope.pkgd.min.js') }}"></script>
    <script defer src="{{ asset ('assets/js/imagesloaded.pkgd.min.js') }}"></script>
    <script defer src="{{ asset ('assets/js/count-to.js') }}"></script>
    <script defer src="{{ asset ('assets/js/jquery.nice-select.min.js') }}"></script>
    <script defer src="{{ asset ('assets/js/validnavs.js') }}"></script>
